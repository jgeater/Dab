...
namespace Dab
{
    public partial class Form1 : Form
    {
                ...
                string sourceDirName, string destDirName, bool copySubDirs)
        {
            ...
            //need to exclude reparsepoints
            //plan: make dirs a null array then loop through using dir.GetDirectories 
            //adding what is returned to the array and catching the exception generated by repars points

            DirectoryInfo[] dirs = dir.GetDirectories();
            //DirectoryInfo[] dirs = dir.GetDirectories().Where(d =>((d.Attributes & FileAttributes.ReparsePoint) != FileAttributes.ReparsePoint));
